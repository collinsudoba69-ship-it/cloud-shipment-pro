...
import { Package2, LayoutDashboard, Package, Users, FileText, LogOut, Plus, Home, Settings as SettingsIcon, Menu, Wallet } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/payments", label: "Payment Tracker", icon: Wallet, end: false },
