...
const hi: TranslationSchema = {
  ...
  trackPage: {
    headerTitle: "शिपमेंट ट्रैक करें",
    headerSubtitle: "रीयल-टाइम अपडेट के लिए अपना ट्रैकिंग नंबर दर्ज करें",
    viewAllShipments: "सभी शिपमेंट देखें",
    inputPlaceholder: "ट्रैकिंग नंबर दर्ज करें (जैसे CLD-8291-5734)",
    tracking: "ट्रैक हो रहा है…",
    track: "ट्रैक करें",
    pleaseEnter: "कृपया ट्रैकिंग नंबर दर्ज करें",
    notFound: "इस ट्रैकिंग नंबर के लिए कोई शिपमेंट नहीं मिला।",
    shipmentNotFound: "शिपमेंट नहीं मिला",
    found: "ट्रैकिंग जानकारी मिली!",
    failed: "ट्रैकिंग विफल",
    unable: "शिपमेंट नहीं मिल रहा। कृपया ट्रैकिंग नंबर जांचें।",
    trackingNumber: "ट्रैकिंग नंबर",
    live: "लाइव",
    copied: "ट्रैकिंग नंबर कॉपी किया गया!",
    printReceipt: "रसीद प्रिंट करें",
    share: "साझा करें",
    receiptDownloaded: "रसीद डाउनलोड हुई",
    receiptFailed: "रसीद बनाने में विफल",
    liveRouteMap: "लाइव रूट मानचित्र",
    shipmentJourney: "शिपमेंट यात्रा",
    progress: "प्रगति",
    stageLabelCreated: "लेबल बनाया गया",
    stageLabelCreatedDesc: "शिपमेंट हमारे सिस्टम में पंजीकृत है",
    stagePickedUp: "उठाया गया",
    stagePickedUpDesc: "कूरियर ने सामान उठा लिया है",
    stageInTransit: "रास्ते में",
    stageInTransitDesc: "पैकेज हब के बीच चल रहा है",
    stageOutForDelivery: "डिलीवरी के लिए निकला",
    stageOutForDeliveryDesc: "अंतिम वाहन प्राप्तकर्ता की ओर है",
    stageDelivered: "डिलीवर हुआ",
    stageDeliveredDesc: "प्राप्तकर्ता को सौंपा गया",
    current: "वर्तमान",
    recentUpdates: "हाल के अपडेट",
    liveFeed: "लाइव फ़ीड",
    new: "नया",
    senderReceiver: "प्रेषक और प्राप्तकर्ता",
    sender: "प्रेषक",
    receiver: "प्राप्तकर्ता",
    packageDescription: "पैकेज विवरण",
    packageImages: "पैकेज चित्र",
    ...
    reason: "कारण",
    paymentRequired: "इस शिपमेंट को रिलीज़ करने से पहले भुगतान आवश्यक है।",
    estimatedDelivery: "अनुमानित डिलीवरी",
    onSchedule: "आपका पैकेज समय पर है",
    ...
    to: "तक",
    needHelp: "मदद चाहिए?",
    needHelpDesc: "अपनी डिलीवरी के बारे में प्रश्न? हमारी सहायता टीम मदद के लिए तैयार है।",
    contactSupport: "सहायता संपर्क",
    readyToTrack: "ट्रैक करने के लिए तैयार",
    readyToTrackDesc: "रीयल-टाइम अपडेट के लिए ऊपर अपना ट्रैकिंग नंबर दर्ज करें।",
